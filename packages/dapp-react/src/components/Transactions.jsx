      ...
      <div className="flex flex-col items-center w-full mt-3">
        <div className="display-flex justify-start w-full mb-6 p-2">
          <a href={`https://ropsten.etherscan.io/address/${addressFrom}`} target="_blank" rel="noreferrer">
            <p className="text-white text-base">发送者: {shortenAddress(addressFrom)}</p>
          </a>
          <a href={`https://ropsten.etherscan.io/address/${addressTo}`} target="_blank" rel="noreferrer">
            <p className="text-white text-base">接收者: {shortenAddress(addressTo)}</p>
          </a>
          <p className="text-white text-base">价值: {amount} ETH</p>
          <p className="text-white text-base">说明: {message||'-'}</p>
        </div>
    ...
    <div className="flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions">
      <div className="flex flex-col md:p-12 py-12 px-4">
        {currentAccount ? (
          ...
          <h3 className="text-white text-3xl text-center my-2"> 连接您的帐户以查看最新交易 </h3>
        )}
